...
namespace Harris7800HMP
{
    internal class WidgetInit
    {
        ...
        public static Widget InitMainMenu2(RadioStation station)
        {
            ...
            mainMenu.LineCharOffset[1] = 4;
            mainMenu.LineCharOffset[2] = 3;
            ...
            mainMenu.AddParam(new Param("UpdateSignal", null, "⟲▮▮▮▯", 2, 19))
            ...
            mainMenu.AddParam(new Param("AgcValue", null, "OFF", 3, 22))
        ...
        public static Widget InitCallMenu(RadioStation station)
        {
            ...
            callMenu.LineSize[0] = 5;
            callMenu.LineSize[1] = 9;
            callMenu.LineSize[2] = 9;
            callMenu.LineSize[3] = 5;
            callMenu.LineCharOffset[0] = 6;
            callMenu.LineCharOffset[1] = 7;
            callMenu.LineCharOffset[2] = 6;
            callMenu.LineCharOffset[3] = 6;
